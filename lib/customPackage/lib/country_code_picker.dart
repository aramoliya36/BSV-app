...
import 'package:consultancy/customPackage/lib/selection_dialog.dart';
import 'package:consultancy/customPackage/lib/universalPlat/universal_platform.dart';
...
import 'countryPicker/src/bottom_sheets/material_bottom_sheet.dart';
...
class CountryCodePicker extends StatefulWidget {
  ...
  /// Set to true if you want to hide the searchScreen part
        ...
        child: Flex(
          ...
          children: <Widget>[
            ...
            if (!widget.hideMainText)
              GetBuilder<CountryPickViewModel>(
                builder: (controller) {
                  print('---controller.isDropMenu----${controller.isDropMenu}');
                  return controller.isDropMenu == ''
                      ? CommonText.textSemiBoldDynamicP(
                          text: 'Choose a country',
                          fontSize: 14.sp,
                          textColor: ColorPicker.hintTextColor)
                      : CommonText.textSemiBoldDynamicP(
                          text: widget.showOnlyCountryWhenClosed
