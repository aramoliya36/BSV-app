...
import 'package:consultancy/view/chat/controller/imageController.dart';
...
class _ChatRoomState extends State<ChatRoom> {
                ...
                child: Align(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      CommonSizeBox.commonSizeBox(width: 8.sp),
                      InkWell(
                        onTap: () async {
                          _bottomController.isRingtone.value = true;
                          _voiceCallScreenController.setTrueVideo(
                          ...
                          kFireStore
                            ...
                            "isCalling": true,
                            "isVideoCall": false,
                            "caller_auth_token": _voiceCallScreenController.uid
                          });
                          _voiceCallScreenController.callerAuthToken =
                          ...
                          kFireStore
                              .collection('UserAllData')
                              .doc(_voiceCallScreenController.uid)
                              .update({
                            "isCalling": true,
                            "isVideoCall": false,
                            "isCallReceived": false,
                          ...
                          Get.to(() => VoiceCallTimeScreenWidget(
                                ...
                                channelName: _agoraTokenResponse.channelName!,
                                tokenId: _agoraTokenResponse.tokenUId!,
                                callerAuthId: _voiceCallScreenController.uid,
                              ));
                        },
                        child: CommonWidget.svgPicture(
                            image: 'assets/svg/call_bottom_icon.svg'),
                      ),
                      CommonSizeBox.commonSizeBox(width: 8.sp),
                      InkWell(
                        onTap: () {},
                    ...
                    children: [
                      StreamBuilder<QuerySnapshot>(
                        stream: FirebaseFirestore.instance
                            .collection('chat')
                            .doc(chatId(PreferenceManager.getTokenId(),
                                _voiceCallScreenController.uid))
                            .collection('Data')
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  suffixIcon: InkWell(
                                    ...
                                    child: Image.asset(
                                        'assets/images/image_camar_i.png'),
                                  ),
  ...
  Future<void> addMsg() async {
    if (_msg.text.isEmpty) {
      ...
      print('------widget.uid----   ${_voiceCallScreenController.uid}');
    } else {
      FirebaseFirestore.instance
          .collection('chat')
          .doc(chatId(
              PreferenceManager.getTokenId(), _voiceCallScreenController.uid))
          .collection('Data')
          .add({
            'date': DateTime.now(),
            'Type': 'Text',
            'senderId': PreferenceManager.getTokenId(),
            'receiveId': _voiceCallScreenController.uid,
            'seen': false,
            'video': '',
            'msg': _msg.text,
            'image': '',
  ...
  uploadImgFirebaseStorage({File? file}) async {
    ...
    print(
        '====chatroom=  ${PreferenceManager.getTokenId()}-${_voiceCallScreenController.uid}');
